...
#ifndef _CuptorApplication_H
#define _CuptorApplication_H
...
/* Forward declaration of the class Cuptor::Application */
#ifndef _CuptorApplication_
  EW_DECLARE_CLASS( CuptorApplication )
#define _CuptorApplication_
#endif

/* Forward declaration of the class Cuptor::GlobalsClass */
#ifndef _CuptorGlobalsClass_
  EW_DECLARE_CLASS( CuptorGlobalsClass )
#define _CuptorGlobalsClass_
#endif
...
EW_DEFINE_FIELDS( CuptorApplication, CoreRoot )
  EW_VARIABLE( GlobalVariables, CuptorGlobalsClass )
EW_END_OF_FIELDS( CuptorApplication )

/* Virtual Method Table (VMT) for the class : 'Cuptor::Application' */
EW_DEFINE_METHODS( CuptorApplication, CoreRoot )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( CuptorApplication )
