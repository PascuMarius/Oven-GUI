...
#ifndef _CuptorCuptorBase_H
#define _CuptorCuptorBase_H
...
/* Forward declaration of the class Cuptor::CuptorBase */
#ifndef _CuptorCuptorBase_
  EW_DECLARE_CLASS( CuptorCuptorBase )
#define _CuptorCuptorBase_
#endif
...
/* Deklaration of class : 'Cuptor::CuptorBase' */
EW_DEFINE_FIELDS( CuptorCuptorBase, CoreGroup )
  EW_OBJECT  ( Background,      ViewsRectangle )
  EW_OBJECT  ( Power,           WidgetSetPushButton )
  EW_OBJECT  ( Stop,            WidgetSetPushButton )
  EW_OBJECT  ( Temp,            WidgetSetPushButton )
  EW_OBJECT  ( Timp,            WidgetSetPushButton )
  EW_OBJECT  ( Meniu,           WidgetSetPushButton )
  EW_OBJECT  ( Minus,           WidgetSetPushButton )
  EW_OBJECT  ( Plus,            WidgetSetPushButton )
  EW_OBJECT  ( Play,            WidgetSetPushButton )
  EW_OBJECT  ( Display,         ViewsRectangle )
EW_END_OF_FIELDS( CuptorCuptorBase )

/* Virtual Method Table (VMT) for the class : 'Cuptor::CuptorBase' */
EW_DEFINE_METHODS( CuptorCuptorBase, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( onClock,           void )( CuptorCuptorBase _this, XObject sender )
EW_END_OF_METHODS( CuptorCuptorBase )
