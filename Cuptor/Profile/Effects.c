...
void EffectsColorEffect__Init( EffectsColorEffect _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( EffectsColorEffect );

  /* Setup the VMT pointer */
  _this->_VMT = EW_CLASS( EffectsColorEffect );
...
EW_DEFINE_CLASS( EffectsColorEffect, EffectsEffect, Outlet, Outlet, Outlet, Value, 
